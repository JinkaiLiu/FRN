    ...
    for epoch_num in range(parser.epochs):
        ...
        if epoch_num % 10 ==0:
            torch.save({'epoch': epoch_total, 'model_state_dict': retinanet.module.state_dict(),
                        ...
                        'loss': np.append(epoch_loss_all,epoch_loss)}, f'/media/data/hucao/zehua/results_ddd17_day/ablation/end/{parser.dataset}_fpn_homographic_retinanet_retinanet101_{epoch_total}.pt')
