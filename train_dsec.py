...
def main(args=None):
    ...
    if parser.dataset == 'csv':
        ...
        if parser.csv_val is None:
            ...
            dataset_val = CSVDataset_event(train_file=parser.csv_val, class_list=parser.csv_classes,
                                     transform=transforms.Compose([Normalizer(), Resizer()]))
    ...
    dataset_val1 = CSVDataset_event(train_file='/media/data/hucao/zhenwu/hucao/DSEC/DSEC_ev_img/DSEC_detection_labels/labels_filtered_test.csv', class_list=parser.csv_classes,
    ...
    for epoch_num in range(parser.epochs):
        ...
        if epoch_num % 5 ==0:
            torch.save({'epoch': epoch_total, 'model_state_dict': retinanet.module.state_dict(),
                        ...
                        'loss': np.append(epoch_loss_all,epoch_loss)}, f'/media/data/hucao/zehua/results_dsec/cross_4layer/{parser.dataset}_fpn_homographic_retinanet_retinanet101_{epoch_total}.pt')
