...
def create_dataset_and_loader(csv_file, class_file, root_event_dir, root_img_dir, event_type='voxel', is_training=True):
    if event_type == 'voxel':
        dataset = CSVDataset_event(train_file=csv_file, class_list=class_file,
...
def main(args=None):
    ...
    dataset_train, dataloader_train = create_dataset_and_loader(args.csv_train, args.csv_classes, 
        ...
        for corruption in corruption_list:
            ...
            for severity in severity_list:
                ...
                if args.event_type == 'voxel':
                    dataset_val1 = CSVDataset_event(train_file= args.csv_test, class_list=args.csv_classes,
